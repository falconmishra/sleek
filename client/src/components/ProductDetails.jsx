...
export const ProductDetails = () => {
  ...
  const [mainsrc, setMainsrc] = useState(
    "https://imagescdn.planetfashion.in/img/app/product/7/785477-9138247.jpg?auto=format&w=494.40000000000003"
  );
  let src1 =
    "https://imagescdn.planetfashion.in/img/app/product/8/857371-10070889.jpg?auto=format&w=494.40000000000003";
  let src2 =
    "https://images.bestsellerclothing.in/data/selected/09-Aug-2023/250135204_1.jpg?width=1080&height=1355&mode=fill&fill=blur&format=auto";
  let src3 =
    "https://www.bushirt.in/cdn/shop/products/1_a667a902-9fe8-454a-8335-b6f87cf4e0fb.jpg?v=1642834022";
  let src4 =
    "https://rukminim2.flixcart.com/image/850/1000/l31x2fk0/t-shirt/d/8/f/xl-ct04221509-rigo-original-image8yhaqfpapnr.jpeg?q=90";
  return (
    <div className=" bg-white px-32 py-12 my-6 h-fit flex justify-center gap-12 rowcol">
      <div className="img-container gap-2 flex flex-col ">
        ...
        <div className="flex">
          <img
            className="hover:opacity-70 h-24 w-24 object-cover object-center"
            src={src1}
            onClick={() => setMainsrc(src1)}
            alt=""
          />
          <img
            className="hover:opacity-70 h-24 w-24 object-cover object-center"
            src={src2}
            onClick={() => setMainsrc(src2)}
            alt=""
          />
          <img
            className="hover:opacity-70 h-24 w-24 object-cover object-center"
            src={src3}
            onClick={() => setMainsrc(src3)}
            alt=""
          />
          <img
            className="hover:opacity-70 h-24 w-24 object-cover object-center"
            src={src4}
            onClick={() => setMainsrc(src4)}
            alt=""
          />
        </div>
      </div>
      ...
      <div className="details flex flex-col gap-2">
        ...
        <div className="flex justify-between">
          <div className="flex items-baseline gap-2">
            <span className="text-[1.5rem] text-purp">${clicked.price}</span>
            <span className="line-through text-[grey]">${clicked.MRP}</span>
            <span className="text-green-500">{clicked.discount}% off</span>
          </div>
