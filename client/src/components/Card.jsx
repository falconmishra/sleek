      ...
      <div>
        <div className="flex mt-3">
          <span className="flex-auto text-[1.15rem] font-semibold">
            <Link to="/productdetails">Women's Sweater</Link>
          </span>
        ...
        <div className="flex gap-2 justify-center my-2">
          <button className="btn2 flex flex-1 items-center justify-center text-[1.5rem]  text-wh1 bg-b1 hover:opacity-90  rounded-full">
            <Link
              to="/cart"
